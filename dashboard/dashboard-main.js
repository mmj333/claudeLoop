...
window.currentSession = currentSession; // Make available globally
...
async function loadSessions() {
  try {
    ...
    select.addEventListener('change', (e) => {
      ...
      updateStatus();
      loadConfig();
      // Update current conversation for new session
      if (window.dashboardConversations && window.dashboardConversations.autoSelectConversation) {
        window.dashboardConversations.autoSelectConversation();
      }
    });
  } catch (error) {
